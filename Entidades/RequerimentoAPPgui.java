...
public class RequerimentoAPPgui extends JFrame { 
    ...
    // Dados de teste FIXOS (para simulação inicial)
    ...
    private void abrirNovoRequerimento() {
        ...
        if (tipoParaRequerimento.getValorTaxa() > 0) {
            ...
            // LINHA CORRIGIDA: getNumero() e getValor() são chamados
    ...
    public static void main(String[] args) { // String[] args é OBRIGATÓRIO e está aqui.
